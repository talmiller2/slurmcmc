...
def slurm_mcmc(log_prob_fun, init_points, num_iters=10, progress=True,
    ...
    # TODO: since acceptance_fraction<1 many points would be rejected and the last step points woudl be
    #  selected again. But doing that same calculation again is wasteful, no need to do it if privously done.
